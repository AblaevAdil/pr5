...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.292247, 76.942015); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.2657351,76.9672489); // ПГУ им. С. Торайгырова
    static final LatLng marker2 = new LatLng(52.2751275,76.9927819); // ТРЦ BatyrMall
    static final LatLng marker3 = new LatLng(52.2695735,76.9843705); // Парк Гагарина
    static final LatLng marker4 = new LatLng(52.2952793,76.9218707); // ГДК
    static final LatLng marker5 = new LatLng(52.2856045,76.939871); // Акимат
  ...
  //      mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.pgu)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.park)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.gdk)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.akimat)).alpha(ALPHA).
